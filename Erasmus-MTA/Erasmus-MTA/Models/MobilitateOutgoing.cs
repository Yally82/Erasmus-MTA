namespace Erasmus_MTA.Models
{
    ...
    [Table("MobilitateOutgoing")]
    public partial class MobilitateOutgoing
    {
        public int ID { get; set; }

        public int ProiectMobilitate { get; set; }

        public int ParticipantATM { get; set; }
        ...
        public decimal GrantErasmusUtilizat { get; set; }
        ...
        public virtual PersonalATM PersonalATM1 { get; set; }
